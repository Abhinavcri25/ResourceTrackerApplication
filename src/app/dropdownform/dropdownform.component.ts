...
//   styleUrl: './dropdownform.component.scss'
// })
...
//   designationList = ['Software Engineer', 'Data Analyst', 'Full Stack Developer', 'Frontend Developer', 'Backend Developer', 'DevOps Engineer'];
//   billableList = ['YES', 'NO'];
//   projectList = ['Schneider Electric', 'Hills', 'Project Z'];
//   locationList = ['Hyderabad', 'Bangalore','Delhi'];
//   techList = ['Angular', 'C#', 'React', 'Postman', 'SQL', 'Node.js', 'Azure', 'Python'];
...
//         switch (key) {
//           case 'empId':
//             employee[key] = 0; // Always insert new
//             break;
//           case 'billable':
...
//       this.empService.AddNewEployee(employee).subscribe({
//         next: () => console.log(`✅ Inserted: ${employee.resourceName}`),
//         error: err => console.error(`❌ Error inserting ${employee.resourceName}:`, err)
//       });
//     }
//   };
